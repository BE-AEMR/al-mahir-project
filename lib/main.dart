...
Future<void> _initializeSupabase() async {
  try {
    ...
    final supabaseUrl = dotenv.env['SUPABASE_URL'] ?? 'https://qxjxzbmihbapoeaebdvk.supabase.co';
    final supabaseKey = dotenv.env['SUPABASE_KEY'] ?? 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InF4anh6Ym1paGJhcG9lYWViZHZrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDEwNzk4MzUsImV4cCI6MjA1NjY1NTgzNX0.x8fV1oOxZyUAvB2eono3TCthWdRpJFc3c2RQ7oU80zw';
